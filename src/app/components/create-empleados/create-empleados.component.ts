...
export class CreateEmpleadosComponent implements OnInit {
  ...
  constructor( private fb: FormBuilder,
               private _empleadoServide: EmpleadoService, 
...
agregarEditarEmpleado(){
  ...
  agregarEmpleado(){
    ...
    this.loading = true;;
    this._empleadoServide.agregarEmpleado(empleado).then( () => {
  ...
  editarEmpleado(id: string) {
    ...
    this._empleadoServide.actualizarEmpleado(id, empleado).then(() => {
      this.loading = false;
  ...
  esEditar() {
    ...
    if ( this.id !== null){
      this.loading = true;
      this._empleadoServide.getEmpleado(this.id).subscribe(data => {
        this.loading = false;
        //Con esto se rellenan los campos automaticamente
